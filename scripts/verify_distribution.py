...
def main() -> int:
    ...
    try:
        ...
        assert initialized_payload["version"] == "0.8.22", initialized_payload
        ...
        assert "Assistant >" not in chat.stdout, chat.stdout
        assert "Runtime started" not in chat.stdout, chat.stdout
        assert "tool call(s)" not in chat.stdout, chat.stdout

        chat_help = run_capture(
            [str(cli), "--workspace", str(workspace), "chat", "--help"],
            cwd=workspace,
        )
        assert "--compact" in chat_help.stdout, chat_help.stdout
        assert "--verbose" in chat_help.stdout, chat_help.stdout
                ...
                for _ in range(200):
                    ...
                    try:
                        ...
                        if response.status_code == 200:
                            ...
                            assert payload["version"] == "0.8.22", payload
                            return process
        ...
        assert diagnostics_payload["version"] == "0.8.22", diagnostics_payload
        ...
        with zipfile.ZipFile(incident) as archive:
            ...
            assert manifest["runtime_version"] == "0.8.22", manifest
        ...
        smoke = textwrap.dedent(
            ...
            async def main():
                ...
                async with httpx.AsyncClient(base_url=base_url, timeout=10) as client:
                    ...
                    assert health.json()["version"] == "0.8.22"
