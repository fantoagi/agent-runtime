...
def main() -> int:
    ...
    try:
        ...
        assert initialized_payload["version"] == "0.8.20", initialized_payload
                ...
                for _ in range(200):
                    ...
                    try:
                        ...
                        if response.status_code == 200:
                            ...
                            assert payload["version"] == "0.8.20", payload
                            return process
        ...
        assert diagnostics_payload["version"] == "0.8.20", diagnostics_payload
        ...
        with zipfile.ZipFile(incident) as archive:
            ...
            assert manifest["runtime_version"] == "0.8.20", manifest
        ...
        smoke = textwrap.dedent(
            ...
            async def main():
                ...
                async with httpx.AsyncClient(base_url=base_url, timeout=10) as client:
                    ...
                    assert health.json()["version"] == "0.8.20"
