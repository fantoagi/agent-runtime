...
一个以 Python + SQLite 实现的可持久化 Agent Runtime。当前版本是 **v0.8.21 Post-change Verification Evidence**，优先解决单机、单用户、本地可信环境下的稳定启动、持续运行、恢复、诊断、学习和直接终端交互问题。
