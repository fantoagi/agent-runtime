...
4. [CURRENT.md](./CURRENT.md)：当前版本已经实现什么、哪些能力仍有限制。
5. [ARCHITECTURE.md](./ARCHITECTURE.md)：Runtime Kernel、Provider、Tool、SQLite、Workflow、API 和本地启动层如何协作。
6. [LEARNING.md](./LEARNING.md)：通过 Learning Console 直观看懂真实事件和处理流程。
7. [CHANGELOG.md](./CHANGELOG.md)：按完成时间倒序查看每次可验收演进。
8. [ROADMAP.md](./ROADMAP.md)：查看当前方向、候选方向和明确暂缓事项。
9. [adr/README.md](./adr/README.md)：查看影响未来兼容性、可靠性或安全边界的架构决策。
